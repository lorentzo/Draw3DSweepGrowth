...
def main():
    ...
    for sketch in bpy.data.collections[sketch_collection_name].all_objects:
        instances = instance_on_path(base_obj=base_penta_sphere, scale_range=[2.0,5.3], curve_path=sketch, t_start=0.0, dt=0.004, frame_start=1, frame_end=n_frames, collection_name=working_collection_name)
